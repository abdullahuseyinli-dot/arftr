"""Separate v2 training with numerically stable matched center-episode operators.
...
def new_episode_model(input_dim, arm, protocol, device="cuda"):
    ...
    model = StableCenterEpisodeMemory(
        input_dim,
        arm,
    ...
    *,
    ...
    request = {
        ...
        "architecture_code_sha256": file_sha256(
            Path(__file__).with_name("stable_center_episode_memory.py")
        ),
